    ...
    public partial class CreateDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Delivery_Items", x => new { x.DeliveryOrderID, x.ItemID, x.WarehouseID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Item_Units", x => new { x.warehouseID, x.ItemID, x.Unit });
                    table.ForeignKey(
                        name: "FK_Item_Units_Item_warehouseID_ItemID",
                        columns: x => new { x.warehouseID, x.ItemID },
                        principalTable: "Item",
                        principalColumns: new[] { "WarehouseID", "ID" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_selling_items", x => new { x.SellingOrderID, x.ItemID, x.WarehouseID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_transfer_items", x => new { x.TransferID, x.ItemID, x.WarehouseID });
                    table.ForeignKey(
